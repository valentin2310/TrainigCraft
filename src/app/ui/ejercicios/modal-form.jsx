...
import { addEjercicio } from "@/app/lib/ejercicio-actions";
...
export default function EjercicioModalForm({ isOpen, onClose, onOpenChange, musculos, ejercicio = null }) {
    const {ejercicios, setEjercicios} = useEjercicios()
    const [state, formAction] = useFormState(addEjercicio, initialState)
    ...
    useEffect(() => {
        ...
        if (!ejercicio) {
            ...
            const _lista = [...ejercicios]
            _lista.push(state.data)
            setEjercicios(_lista)
                            ...
                            <ModalBody className="max-h-[500px] overflow-y-auto">        
                                <div className="my-5 flex flex-col gap-5">
                                    ...
                                    <Select
                                        ...
                                        defaultValue={ejercicio?.musculos}
